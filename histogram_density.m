...
for idx = 1:1000:30001
    T1=readtable(['/Users/yuzheng/Desktop/Fiber_model_Code/fiber/fiber_huan2/fiberPosition',num2str(idx-1),'.csv']);
    x=T1.Var1;
    y=T1.Var2;
    density = T1.Var3;
    x = x - 0.5;
...
close;
filename = 'fiber/histogram_fiber_density.gif'; % Specify the output file name
for idx = 1:1000:30001
